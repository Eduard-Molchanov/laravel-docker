...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="/activation" class="nav-link">Активация учетной записи</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
            <a href="/new-password" class="nav-link">Обновить пароль</a>
            </li>
        </ul>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="{{asset('adminlte/ist/img/user8-128x128.jpg')}}" alt="User Avatar"
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Личные кабинеты</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
